...
const CareGiverCard = ({careGiver}) => {
  return (
    <div className="card shadow max-w-[400px] mx-auto cursor-pointer group transition-all hover:shadow-lg">
      <div className="img flex justify-center max-h-[300px] overflow-hidden">
        <Image src={careGiver.image} alt="Care Givers" width={400} height={250} className="rounded rounded-b-none object-cover group-hover:scale-125 transition-all" />
      </div>
