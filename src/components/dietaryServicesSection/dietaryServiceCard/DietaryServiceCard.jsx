...
const DietaryServiceCard = ({dietaryData}) => {
  return (
    <div className="card shadow rounded mx-auto cursor-pointer group transition-all hover:shadow-lg bg-green-100 text-slate-700">
      ...
      <div className="info mt-5 px-3 pb-5">
        ...
        <p className="text-justify">{dietaryData.description}</p>
      </div>
    </div>
  );
}

export default DietaryServiceCard